...
public class HushedStorageBlockEntities
{
    ...
    public static DeferredHolder<BlockEntityType<?>,BlockEntityType<?>> HUSHED_STORAGE_BLOCK_ENTITY(String name)
    {
        return BLOCK_ENTITIES.register(name,() -> new BlockEntityType<>(BaseHushedBlockEntity::new,Set.of(
                ...
                HushedStorageBlocks.HUSHED_STRIPPED_ACACIA_LOG.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_OAK_LOG.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_BIRCH_LOG.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_JUNGLE_LOG.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_SPRUCE_LOG.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_DARK_OAK_LOG.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_CHERRY_LOG.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_MANGROVE_LOG.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_BAMBOO_BLOCK.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_CRIMSON_STEM.value(),
                HushedStorageBlocks.HUSHED_STRIPPED_WARPED_STEM.value(),
                ...
                HushedStorageBlocks.HUSHED_COBBLED_DEEPSLATE.value(),
                ...
                HushedStorageBlocks.HUSHED_OBSIDIAN.value(),
                HushedStorageBlocks.HUSHED_CRYING_OBSIDIAN.value(),
                HushedStorageBlocks.HUSHED_NETHERRACK.value(),
                HushedStorageBlocks.HUSHED_SAND.value(),
                HushedStorageBlocks.HUSHED_SANDSTONE.value(),
                HushedStorageBlocks.HUSHED_RED_SAND.value(),
                HushedStorageBlocks.HUSHED_RED_SANDSTONE.value(),
                HushedStorageBlocks.HUSHED_GRAVEL.value(),
                HushedStorageBlocks.HUSHED_DIRT.value(),
                HushedStorageBlocks.HUSHED_COARSE_DIRT.value(),
                HushedStorageBlocks.HUSHED_ROOTED_DIRT.value()
        ),null));
    }
}
